...
[DynamicWebApi]
public abstract class SqlQueryServiceBase<T> : IDisposable, IDynamicWebApi, IAsyncQueryService<T> where T : class, IDataModel, new()
{
    ...
    public SqlQueryServiceBase(IDatabaseSetting settings)
    {
...
/// <typeparam name="T"></typeparam>
[DynamicWebApi]
public abstract class SqlRestServiceBase<T> : SqlQueryServiceBase<T>, IAsyncRestService<T> where T : class, IDataModel, new()
{
    public SqlRestServiceBase(IDatabaseSetting settings) : base(settings) { }
